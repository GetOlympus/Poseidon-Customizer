...
class Option
{
    ...
    public static function add($option, $value, $deprecated = '', $autoload = 'yes') : void
    {
         ...
         * @param  string  $autoload
         */
        do_action('ol.poseidon.option_add_before_'.$option, $value, $deprecated, $autoload);
         ...
         * @param  string  $autoload
         */
        do_action('ol.poseidon.option_add_after_'.$option, $value, $deprecated, $autoload);
    }
    ...
    public static function delete($option) : void
    {
         ...
         * @var    string  $option
         */
        do_action('ol.poseidon.option_delete_before_'.$option);
         ...
         * @var    string  $option
         */
        do_action('ol.poseidon.option_delete_after_'.$option);
    }
    ...
    public static function get($option, $default = '', $item = '')
    {
         ...
         * @return array
         */
        $value = apply_filters('ol.poseidon.option_get_'.$option, $value);
    ...
    public static function set($option, $value, $type = '', $id = 0) : void
    {
         ...
         * @return array
         */
        $value = apply_filters('ol.poseidon.option_set_'.$option, $value);
        ...
        if (!empty($id)) {
            ...
            $func = false === get_option($option) ? 'add' : 'update';
    ...
    public static function update($option, $value) : void
    {
         ...
         * @param  string  $value
         */
        do_action('ol.poseidon.option_update_before_'.$option, $value);
         ...
         * @param  string  $value
         */
        do_action('ol.poseidon.option_update_after_'.$option, $value);
    }
    ...
    public static function getAdminOption($admin_id, $option = '', $default = '')
    {
         ...
         * @return mixed
         */
        return apply_filters('ol.poseidon.option_get_admin_page_'.$option, $value);
    }
    ...
    public static function updateAdminOption($admin_id, $option, $value) : void
    {
         ...
         * @param  string  $admin_id
         */
        do_action('ol.poseidon.option_update_admin_page_before_'.$option, $value, $admin_id);
         ...
         * @param  string  $admin_id
         */
        do_action('ol.poseidon.option_update_admin_page_after_'.$option, $value, $admin_id);
    }
    ...
    public static function getAuthorMeta($user_id, $option)
    {
         ...
         * @return mixed
         */
        return apply_filters('ol.poseidon.option_get_author_meta_'.$option, $value);
    }
    ...
    public static function updateAuthorMeta($user_id, $option, $value) : void
    {
         ...
         * @param  int     $user_id
         */
        do_action('ol.poseidon.option_update_user_meta_before_'.$option, $value, $user_id);
         ...
         * @param  int     $user_id
         */
        do_action('ol.poseidon.option_update_user_meta_after_'.$option, $value, $user_id);
    }
    ...
    public static function getPostMeta($post_id, $option)
    {
         ...
         * @return mixed
         */
        return apply_filters('ol.poseidon.option_get_post_meta_'.$option, $value, $post_id);
    }
    ...
    public static function updatePostMeta($post_id, $option, $value) : void
    {
         ...
         * @param  int     $post_id
         */
        do_action('ol.poseidon.option_update_post_meta_before_'.$option, $value, $post_id);
         ...
         * @param  int     $post_id
         */
        do_action('ol.poseidon.option_update_post_meta_after_'.$option, $value, $post_id);
    }
    ...
    public static function getTermMeta($term_id, $option, $default = '')
    {
         ...
         * @return mixed
         */
        return apply_filters('ol.poseidon.option_get_term_meta_'.$option, $value);
    }
    ...
    public static function updateTermMeta($term_id, $option, $value) : void
    {
         ...
         * @param  int     $term_id
         */
        do_action('ol.poseidon.option_update_term_meta_before_'.$option, $value, $term_id);
         ...
         * @param  int     $term_id
         */
        do_action('ol.poseidon.option_update_term_meta_after_'.$option, $value, $term_id);
    }
}
